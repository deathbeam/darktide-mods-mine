...
return {
    laser_blade_2h_force_sword_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_2h_force_sword_p1_01",
        ...
        -- Positions
        laser_offset = vector3_box(0, 0, -.9),
        -- laser_1_offset = vector3_box(0, 0, -.9),
        -- laser_2_offset = vector3_box(0, 0, -.9),
        -- laser_3_offset = vector3_box(0, 0, -.9),
        -- vent_offset = vector3_box(0, 0, -.9),
        distortion_offset = vector3_box(0, 0, -1.5),
        -- Sizes
        -- laser_1_size = vector3_box(.3, 1, .3),
        -- laser_2_size = vector3_box(.25, 1.015, .25),
        -- laser_3_size = vector3_box(.175, 1.025, .175),
    ...
    laser_blade_2h_force_sword_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_2h_force_sword_p1_02",
        icon_render_unit_rotation_offset = {90, -30, 0},
        icon_render_camera_position_offset = {0, -4, .95},
        damage_type = "metal_slashing_heavy",
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
        ...
        distortion_offset = vector3_box(0, 0, -1.5),
        distortion_size = vector3_box(1, 3, 1),
        tip_size_1 = vector3_box(.25, 1.065, .25),
        tip_size_2 = vector3_box(.175, 1.075, .175),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.3, 1.05, .3),
        fire_node = 2,
        ui_item_init = function(world, attachment_unit, attachment_data, customization_item)
            laser_blade_functions.spawn_preview_blade(world, attachment_unit, attachment_data, customization_item)
        end,
    ...
    laser_blade_2h_force_sword_green_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_2h_force_sword_p1_01",
        icon_render_unit_rotation_offset = {90, -30, 0},
        icon_render_camera_position_offset = {0, -4, .95},
        damage_type = "metal_slashing_heavy",
    ...
    laser_blade_2h_force_sword_green_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_2h_force_sword_p1_02",
        icon_render_unit_rotation_offset = {90, -30, 0},
        icon_render_camera_position_offset = {0, -4, .95},
        damage_type = "metal_slashing_heavy",
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
