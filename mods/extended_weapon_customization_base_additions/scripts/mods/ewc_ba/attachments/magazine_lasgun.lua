...
local magazine_lasgun_recon = mod:io_dofile("extended_weapon_customization_base_additions/scripts/mods/ewc_ba/attachments/magazine_lasgun_recon")
...
return table_merge_recursive_n(nil, magazine_lasgun_helbore, magazine_lasgun_infantry, magazine_lasgun_recon)
