...
return {
    laser_blade_force_sword_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_force_sword_p1_01",
        ...
        laser_offset = vector3_box(0, 0, -.1),
        distortion_offset = vector3_box(0, 0, 0),
        distortion_size = vector3_box(1, 1.6, 1),
        tip_size_1 = vector3_box(.25, .775, .25),
        tip_size_2 = vector3_box(.175, .79, .175),
        fire_color = vector3_box(1, 0, 0),
        fire_size = vector3_box(.35, .76, .35),
        fire_node = 1,
    ...
    laser_blade_force_sword_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_force_sword_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.5, .7},
        damage_type = "metal_slashing_medium",
        particle_effect_name = "content/fx/particles/enemies/sniper_laser_sight",
    ...
    laser_blade_green_force_sword_p1_01 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_force_sword_p1_01",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.5, .7},
        damage_type = "metal_slashing_medium",
    ...
    laser_blade_green_force_sword_p1_02 = {
        replacement_path = _item_melee.."/blades/laser_blade_green_force_sword_p1_02",
        icon_render_unit_rotation_offset = {90, 30, 0},
        icon_render_camera_position_offset = {-.025, -2.5, .7},
        damage_type = "metal_slashing_medium",
        particle_effect_name = "content/fx/particles/enemies/plasma_gun_laser_sight",
