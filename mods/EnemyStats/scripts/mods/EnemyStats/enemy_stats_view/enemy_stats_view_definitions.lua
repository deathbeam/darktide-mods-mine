...
local scenegraph_definition = {
    ...
    enemy_stats_list_content = {
        vertical_alignment = 'top',
        parent = 'enemy_stats_list_background',
        horizontal_alignment = 'left',
        size = { grid_width, grid_height },
        position = { 0, 0, 1 },
    },
    enemy_stats_detail_background = {
        vertical_alignment = 'top',
        parent = 'screen',
        horizontal_alignment = 'left',
    ...
    enemy_stats_detail_content = {
        vertical_alignment = 'top',
        parent = 'enemy_stats_detail_background',
        horizontal_alignment = 'left',
        size = { detail_width, detail_height },
        position = { 0, 0, 1 },
    },
    enemy_stats_title_text = {
        vertical_alignment = 'top',
        parent = 'screen',
        horizontal_alignment = 'left',
        size = { 1200, 50 },
...
local widget_definitions = {
    enemy_stats_title_text = UIWidget.create_definition({
        {
            value_id = 'text',
            style_id = 'text',
            pass_type = 'text',
    ...
    enemy_stats_search = UIWidget.create_definition(
        TextInputPassTemplates.terminal_input_field,
        'enemy_stats_search',
        { grid_width, search_height }
    ),
    enemy_stats_list_background = UIWidget.create_definition({
        {
            pass_type = 'rect',
            style = {
                color = { 200, 0, 0, 0 },
    ...
    enemy_stats_detail_background = UIWidget.create_definition({
        {
            pass_type = 'rect',
            style = {
                color = { 200, 0, 0, 0 },
