                ...
                sub_widgets = {
                    ...
                    _keybind('select_mode_toggle', 'select_mode_toggle'),
                    {
                        ...
                        options = {
                            ...
                            { text = 'hud_display_icon', value = 'icon', show_widgets = { 1, 2 } },
                            { text = 'hud_display_name', value = 'name', show_widgets = { 1, 2 } },
                            { text = 'hud_display_icon_and_name', value = 'icon_and_name', show_widgets = { 1, 2 } },
                        },
                        sub_widgets = {
                            {
                ...
                sub_widgets = {
                    {
                        ...
                        options = {
                            { text = 'mode_1', value = 'mode_1', show_widgets = { 1 } },
                            { text = 'mode_2', value = 'mode_2', show_widgets = { 2 } },
                            { text = 'mode_3', value = 'mode_3', show_widgets = { 3 } },
                            { text = 'mode_4', value = 'mode_4', show_widgets = { 4 } },
                        },
                        sub_widgets = {
