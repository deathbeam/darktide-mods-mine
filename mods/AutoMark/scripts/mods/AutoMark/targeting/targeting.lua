...
local SMART_TARGETING_PRECISION_TEMPLATE = {
...
function mod:find_target_unit(only_direct_hit)
    ...
    smart_targeting_extension._precision_target_aim_assist:update_precision_target(
        ...
        only_direct_hit and SMART_TARGETING_PRECISION_TEMPLATE or SMART_TARGETING_TEMPLATE,
