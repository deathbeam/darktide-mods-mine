...
localization.auto_crafter_group = "自动制作助手（阶段 1C/2 安全修改）"
...
localization.auto_crafter_workflow_group = "制作流程（计划选项）"
localization.auto_crafter_resuming_group = "继续制作物品选项"
localization.auto_crafter_buy_until_target = "自动购买，直到找到低项属性目标武器"
localization.auto_crafter_buy_until_target_tooltip = "使用已实现的串行布伦特购买搜索。后续阶段会把其余流程选项连接到选定候选。"
...
localization.auto_crafter_allocate_mastery_points_tooltip = "目前仅为界面规划选项。选择精通 20 级后可在军械库面板启用；后端分配尚未连接。"
localization.auto_crafter_consecrate_transcendent = "自动将武器祝圣为超凡"
localization.auto_crafter_consecrate_transcendent_tooltip = "目前仅为界面规划选项。后续只会为最终候选补充缺少的稀有度阶段。"
localization.auto_crafter_upgrade_expertise_500 = "自动将武器物品等级提升至 500"
localization.auto_crafter_upgrade_expertise_500_tooltip = "目前仅为界面规划选项。精通奖励允许后，最终候选将提升至 500 武器等级。"
localization.auto_crafter_change_perks = "更改专长"
localization.auto_crafter_change_perks_tooltip = "需要先将武器精通提升至 20 级以解锁 IV 级专长。目标发现已启用；替换尚未连接。"
localization.auto_crafter_change_blessings = "更改祝福"
localization.auto_crafter_change_blessings_tooltip = "目前仅为界面规划选项。军械库面板中需要精通 20 级；祝福发现、解锁和替换尚未连接。"
localization.auto_crafter_trait_targets_group = "专长和祝福目标（计划）"
...
localization.auto_crafter_perk_target_tooltip = "需要精通 20 级和更改专长。自动选择仅使用当前武器目录中的兼容 IV 级专长；替换尚未连接。"
