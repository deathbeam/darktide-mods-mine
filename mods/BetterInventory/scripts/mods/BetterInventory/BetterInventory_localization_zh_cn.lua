...
localization.auto_crafter_best_candidate_fallback = "未命中目标时保留最佳候选"
localization.auto_crafter_best_candidate_fallback_tooltip = "达到上限仍未找到精确目标时保留最接近候选供后续查看。失败物品不会被静默丢弃。默认关闭。"
...
localization.auto_crafter_panel_best_fallback = "最佳候选回退"
