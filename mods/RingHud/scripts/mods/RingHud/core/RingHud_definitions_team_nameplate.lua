-- File: RingHud/scripts/mods/RingHud/core/RingHud_definitions_team_nameplate.lua
...
function W.build_marker_definitions(scale, scenegraph_id)
    ...
    local content = {
        ...
        -- Text values (driven at runtime)
        reserve_text_value     = "", -- team_ammo.update_ammo(...)
        ability_cd_text        = "", -- team_ability.update_ability_cd(...)
        toughness_text_value   = "", -- team_toughness.update_text(...)
        health_value_text      = "",
    }
