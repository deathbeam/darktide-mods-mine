-- File: RingHud/scripts/mods/RingHud/team/widgets.lua
...
-- The tile-only widget (ring, segments, icons, ammo/cd texts)
local function make_tile_only_widget_def(node_name)
    ...
    for i = 1, C.MAX_HP_SEGMENTS do
        ...
        _add_pass(passes, style, {
            ...
            style                = {
                ...
                angle                = 0,
                color                = { 255, 255, 255, 255 }, -- TODO Color
                material_values      = {
                    amount               = 0,
                    ...
                    outline_color        = { 1, 1, 1, 1 }, -- TODO Color
                    lightning_opacity    = 0,
                    glow_on_off          = 0,
                },
            }
        ...
        _add_pass(passes, style, {
            ...
            style                = {
                ...
                material_values      = {
                    ...
                    outline_color        = { 0.8, 0.27, 0.8, 1.0 }, -- TODO Color
                    lightning_opacity    = 0,
                    glow_on_off          = 0,
                },
            }
    ...
    _add_pass(passes, style, {
        ...
        style                = {
            ...
            material_values      = {
                ...
                fill_outline_opacity = { 1.3, 1.3 },
                outline_color        = { 1, 0.2, 0.2, 1.0 },  -- overwritten at runtime as needed -- TODO Color
                lightning_opacity    = 0,
                glow_on_off          = 0,
            },
        }
    ...
    _add_pass(passes, style, {
        ...
        style                = {
            ...
            color                = { 255, 255, 255, 255 }, -- applier may override via vm.status_icon_tint -- TODO Color
        }
    })
    ...
    _add_pass(passes, style, {
        ...
        style                = {
            ...
            -- offset               = { -C.TILE_SIZE / 9, -C.TILE_SIZE / 16, 3 },
            -- offset               = { -C.TILE_SIZE / 9, -C.TILE_SIZE / 32, 4 }, -- TODO Test level with ammo reserve
            offset               = { -C.TILE_SIZE / 9, -C.TILE_SIZE / 50, 4 }, -- TODO Test level with ammo reserve
    ...
    _add_pass(passes, style, {
        ...
        style                = (function()
            ...
            s.font_size                 = C.TILE_SIZE / 13.5 -- 14.8
            s.visible                   = false
            return s
        end)()
    })

    -- Ability cooldown: right/center
    _add_pass(passes, style, {
        pass_type            = "text",
        ...
        style                = (function()
            ...
            s.text_color                = { 255, 255, 255, 255 } -- TODO Color
    ...
    -- Toughness integer (right side; above ability CD). Default hidden; VM/applier decides.
    _add_pass(passes, style, {
        pass_type            = "text",
        ...
        style                = (function()
            ...
            s.text_color                = { 255, 108, 187, 196 } -- ARGB -- TODO Color
            s.font_size                 = C.TILE_SIZE / 13.5
            s.visible                   = false
            return s
        end)()
    ...
    -- Health integer (left lower). Default hidden; VM/applier decides.
    _add_pass(passes, style, {
        pass_type            = "text",
        ...
        style                = (function()
            ...
            s.text_color                = { 255, 255, 255, 255 } -- pure white -- TODO Color
            s.font_size                 = C.TILE_SIZE / 13.5
            s.visible                   = false
            return s
        end)()
...
local function make_name_only_widget_def(node_name)
    ...
    _add_pass(passes, style, {
        ...
        style                = (function()
            ...
            s.offset                    = { 0, 0, 50 }
            -- Optional: you can leave text_color unset; baseline white is fine.
