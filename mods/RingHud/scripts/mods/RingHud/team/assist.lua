-- File: RingHud/scripts/mods/RingHud/team/assist.lua
local mod = get_mod("RingHud"); if not mod then return end

---------------------------------------------------------------------
-- Safe requires (some builds may differ)
---------------------------------------------------------------------
...
-- Optional victim-side utility (also victim/anim based; no interactor comps)
local VictimAssist        = _try_require(
    "scripts/extension_systems/character_state_machine/character_states/utilities/assist")
...
local function _assist_duration_for(unit, status)
    ...
    if ext and ext.interaction_length then
        local ok, len = pcall(function() return ext:interaction_length() end)
