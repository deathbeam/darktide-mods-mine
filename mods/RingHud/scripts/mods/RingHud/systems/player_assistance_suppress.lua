...
-- Modes in which suppression is allowed
local SUPPRESS_MODES = {
    team_hud_icons_vanilla    = true,
    team_hud_icons_mini       = true,
    team_hud_icons_docked     = true,
    team_hud_floating         = true,
    team_hud_floating_docked  = true,
    team_hud_floating_vanilla = true,
    team_hud_floating_mini    = true,
}

-- Name/Icon settings required to trigger suppression (must be "special" to provide the replacement visual)
local SUPPRESS_ICONS = {
    name1_icon1_status1 = true,
    name1_icon0_status1 = true,
    name0_icon1_status1 = true,
    name0_icon0_status1 = true,
}
...
local function _should_suppress()
    ...
    -- Suppression active ONLY if both the Mode is correct AND the Icon setting is correct
    return (SUPPRESS_MODES[s.team_hud_mode] == true)
        and (SUPPRESS_ICONS[s.team_name_icon] == true)
end
