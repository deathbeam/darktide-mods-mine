...
template.check_line_of_sight = mod:get("chest_require_line_of_sight")
template.screen_clamp = mod:get("chest_keep_on_screen")

template.evolve_distance = 1
template.max_distance = mod:get("chest_max_distance")
template.data = {}
