...
template.size = size
template.name = "chest_item_marker"
...
template.check_line_of_sight = mod:get("chest_require_line_of_sight") or false
template.screen_clamp = mod:get("chest_keep_on_screen") or false

template.evolve_distance = 1
template.max_distance = mod:get("chest_max_distance") or 50
template.data = {}
...
template.create_widget_defintion = function(template, scenegraph_id)
    ...
    return UIWidget.create_definition(
               {
            {
                ...
                value_id = "ring",
                style = {
                    horizontal_alignment = "center", vertical_alignment = "center", size = size, offset = {0, 0, 5}, color = {255, 226, 199, 126}
                }, visibility_function = function(content, style)
                ...
                pass_type = "texture", style_id = "icon", value = "content/ui/materials/hud/interactions/icons/default", value_id = "icon",
                style = {
                    horizontal_alignment = "center", vertical_alignment = "center", size = icon_size, offset = {0, 0, 3}, color = Color.ui_hud_green_super_light(255, true)
                }, visibility_function = function(content, style)
