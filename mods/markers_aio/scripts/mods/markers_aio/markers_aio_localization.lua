...
local loc = {
	...
	-- STOLEN RATIONS Markers
	rations_markers_settings = {
		en = "STOLEN RATIONS MARKERS",
	},
	rations_enable = {
		en = "Enable Markers",
		fr = "Activer les marqueurs",
	...
	rations_colour = {
		en = "Stolen Rations Markers Colour",
	},
	rations_colour_R = {
		en = "R",
		fr = "R",
