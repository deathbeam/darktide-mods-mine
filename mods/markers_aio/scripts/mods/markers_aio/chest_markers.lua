			...
			--[[if self._chest_extension then
				...
				for _, pickup_name in pairs(chest_items) do
					...
					if current_marker == false then
						...
						current_marker.template.fade_settings.distance_min = current_marker.template.max_distance
							- current_marker.template.evolve_distance * 2
						...
						if pickup_name == "large_metal" then
							current_marker.widget.content.icon =
