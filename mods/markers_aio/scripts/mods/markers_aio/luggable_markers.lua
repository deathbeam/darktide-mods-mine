...
mod.update_luggable_markers = function(self, marker)
	if marker and self then
		...
		if
			pickup_type and pickup_type == "battery_01_luggable"
			or pickup_type == "expedition_explosive_luggable_01"
			or pickup_type == "battery_02_luggable"
			or pickup_type == "container_01_luggable"
			or pickup_type == "container_02_luggable"
			or pickup_type == "container_03_luggable"
			or pickup_type == "control_rod_01_luggable"
			or pickup_type == "prismata_case_01_luggable"
		then
			marker.draw = false
